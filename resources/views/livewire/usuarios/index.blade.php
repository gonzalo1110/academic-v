<div class="p-4 md:p-6 lg:p-8 animate-fade-in">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <h2 class="font-display text-2xl font-bold text-gray-800">Gestión de Usuarios</h2>
            <p class="text-sm text-gray-500 mt-1">Administra docentes, estudiantes y administradores</p>
        </div>
        <a href="{{ route('admin.usuarios.crear') }}" class="btn-gradient btn btn-sm gap-2 flex-shrink-0">
